...
function fullName(){
    document.getElementById("FunctionQ1").innerHTML="Kanthasuwamy Kumaran"
}
fullName()
...
function fullName(firstName, lastName) {
  ...
  let myFullName = fullName("A.R", "Rahman");
...
function addNumbers(num1, num2) {
  ...
  document.getElementById("FunctionQ3").innerHTML=result;
...
let rectangleArea = areaOfRectangle(5,10);
document.getElementById("FunctionQ4").innerHTML=rectangleArea;
...
function perimeterOfRectangle(length, width) {
  ...
  document.getElementById("FunctionQ5").innerHTML=rectanglePerimeter;
...
function volumeOfRect(length, width, height) {
  ...
  document.getElementById("FunctionQ6").innerHTML=prismVolume;
...
function areaOfCircle(radius) {
  ...
  document.getElementById("FunctionQ7").innerHTML=circleArea;
  ...
  document.getElementById("FunctionQ8").innerHTML=circleCircumference;
...
document.getElementById("FunctionQ9").innerHTML="Temperature in Fahrenheit: " + temperatureInFahrenheit;
...
document.getElementById("FunctionQ10").innerHTML =(calculateBMI(80,180));



// //Map
//01.Square the value of every element in the array. Assume that you will only get numbers in the input array.
let aquareValue = [1,2,3,4,5]
let newAquare = aquareValue.map(x => x*x)
document.getElementById("MapQ1").innerHTML = newAquare

//02.If the given input is an array of numbers, return the sum of all the positive ones. If the array is empty or there aren't any positive numbers, return 0.
